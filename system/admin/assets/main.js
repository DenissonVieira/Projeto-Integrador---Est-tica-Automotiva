        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              text: "Veículos",
              href: "vehicles.html",
              icon: '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A2 2 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/>',
            },
            {
              key: "services",
              text: "Serviços",
        ...
        (s &&
          (s.outerHTML = (function (e) {
            const t = n
              ...
              .join("");
            // return `\n    <aside class="d-sidebar">\n      <div class="brand">\n        <div class="brand-logo"><svg viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">\n  <path fill="#ffffff" d="M14.747 9.125c.527-1.426 1.736-2.573 3.317-2.573c1.643 0 2.792 1.085 3.318 2.573l6.077 16.867c.186.496.248.931.248 1.147c0 1.209-.992 2.046-2.139 2.046c-1.303 0-1.954-.682-2.264-1.611l-.931-2.915h-8.62l-.93 2.884c-.31.961-.961 1.642-2.232 1.642c-1.24 0-2.294-.93-2.294-2.17c0-.496.155-.868.217-1.023l6.233-16.867zm.34 11.256h5.891l-2.883-8.992h-.062l-2.946 8.992z"/>\n</svg></div>\n        <div class="brand-text">\n          <div class="brand-name">Reluz</div>\n          <div class="brand-tag">Estética Automotiva</div>\n        </div>\n      </div>\n      ${t}\n      <div class="sidebar-footer">\n        <div class="workspace">\n          <div class="workspace-avatar">JD</div>\n          <div class="workspace-text">\n            <div class="workspace-name">John Doe</div>\n            <div class="workspace-role">admin</div>\n          </div>\n          <svg class="workspace-chev" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">\n            <path d="m7 9 5-5 5 5"/><path d="m7 15 5 5 5-5"/>\n          </svg>\n        </div>\n      </div>\n    </aside>`;
            return `<aside class="d-sidebar"><div class="brand"><div class="brand-logo"><svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="200" cy="200" r="180" stroke="#2b2f35" stroke-width="8"/><circle cx="200" cy="200" r="150" stroke="#2b2f35" stroke-width="4"/><circle cx="200" cy="200" r="120" stroke="#2b2f35" stroke-width="4"/><g stroke="#e8a23a" stroke-width="12" stroke-linecap="round" opacity="0.85"><path d="M200 40 A160 160 0 0 1 340 120"/><path d="M360 200 A160 160 0 0 1 305 335"/><path d="M200 360 A160 160 0 0 1 62 288"/><path d="M40 190 A160 160 0 0 1 90 68"/></g><circle cx="200" cy="200" r="34" fill="#1c1f24" stroke="#e8a23a" stroke-width="8"/><circle cx="200" cy="200" r="12" fill="#e8a23a"/></svg></div><div class="brand-text"><div class="brand-name">Reluz</div><div class="brand-tag">Estética Automotiva</div></div></div>${t}<div class="sidebar-footer"><div class="workspace"><div class="workspace-avatar">JD</div><div class="workspace-text"><div class="workspace-name">John Doe</div><div class="workspace-role">admin</div></div><svg class="workspace-chev" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="m7 9 5-5 5 5"/><path d="m7 15 5 5 5-5"/></svg></div></div></aside>`;
          })(t)),
          r && (r.outerHTML = o(a)),
          i &&
            (i.outerHTML =
